...
Nonethess, in some of the examples below, I also rely on the [tidyverse](https://github.com/tidyverse) ecosystem, so you would need to install this as well to reproduce the content of this README:
...
The main fonction of this package is called `tcor` and its documentation is available here:
